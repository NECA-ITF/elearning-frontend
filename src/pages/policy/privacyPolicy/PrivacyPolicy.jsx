    ...
    return (
      <div>
        ...
        <div className='policy'>
          ...
          <p>
            Your personal data is created, stored and transmitted in a variety of paper and electronic formats, including databases at Eduspot. It is Eduspot's policy to limit access to and the use of your personal data to ITF staff, faculty and authorized affiliates who have a legitimate interest in it for the purpose of carrying out their professional and contractual duties.
          </p>
          <p>
            Your personal data relating to your Eduspot-study program will be used, shared and otherwise processed by staff, faculty, and other persons directly associated with the program, as well as other ITF offices whose services support study abroad programs, including the Offices in the Federation.
          </p>
          <p>
            The program will also share your personal data with your school or prospective employer, and other Eduspot departments as part of your profile, and for a variety of other academic, educational, administrative, research and statistical purposes.
          </p>
        </div>
      </div>
    )
