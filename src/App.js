  ...
  return (
    <div>
      <Router>
        ...
        <Route path="/admin-dash" element={<AdminDashBoard API_URL={API_URL} setCurrentCourse={setCurrentCourse} />} />
        ...
        <Route path="/admin-outline" element={<AdminOutline API_URL={API_URL} currentCourse={currentCourse} setCurrentCourseOutline={setCurrentCourseOutline} />} />
